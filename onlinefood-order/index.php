    ...
    <section class="food-search text-center">
        <div class="container">
            ...
            <form action="<?php echo SITEURL; ?>food-search.php" method="POST">
                <input type="search" name="search" placeholder="Burger Name " required>
    ...
    <section class="categories">
        <div class="container">
            <h2 class="text-center">Types of burgers that we offer</h2>
    ...
    <section class="food-menu">
        <div class="container">
            ...
            //SQL Query
            $sql2 = "SELECT * FROM tbl_food WHERE active='Yes' AND featured='Yes' LIMIT 20";
                            ...
                            <?php
                                if (isset($_SESSION['user'])) {
                                    ...
                                    echo '<a href="' . SITEURL . 'order.php?food_id=' . $id . '" class="btn btn-primary">Order Now</a>';
                                        ...
                                        echo '<a href="' . SITEURL . 'regulogin.php" class="btn btn-primary">Login to Order</a>';
                                    }
                                ?>
                        </div>
                    </div>
